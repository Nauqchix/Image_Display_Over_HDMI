...
## Pmod Header JB
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { uart_rx }]; #IO_L8P_T1_34 Sch=JB1_P (Pin 1)
...
# set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { uart_rx }]; #IO_L14P_T2_SRCC_13  Sch=CK_IO41
